...
const researchBanner = () =>
  `<section class="research-banner"><div><span class="tag">RESEARCH · NOT AVAILABLE</span><h3>Liquidity sweep · v0</h3><p>A new idea: wait for a sweep, then confirmation. Being defined and evaluated; not available to activate.</p></div><button class="button" data-research>Explore the idea ↗</button></section>`;
const recent = () =>
...
const researchQueue = () =>
  `<section class="candidate-queue" aria-labelledby="candidate-title"><div class="section-heading"><div><p class="kicker">POSSIBLE NEXT ADDITIONS</p><h2 id="candidate-title">A library that earns its place.</h2></div><span class="tag">PROPOSED / UNTESTED</span></div><p class="muted">MA125 stays. Liquidity + structure is a separate candidate. These further ideas need their own research before they can become selectable.</p><div class="candidate-grid"><article class="candidate-card"><span class="candidate-number">01</span><h3>BTC channel breakout</h3><p>Follow a move beyond a prior price range, with a separate exit rule.</p><details><summary>Why consider it?</summary><p>Clear, reproducible rules. First research priority after the liquidity study. It can suffer repeated false breakouts and may overlap with MA125’s risks.</p></details></article><article class="candidate-card"><span class="candidate-number">02</span><h3>Volatility-managed trend</h3><p>Keep the trend rule; adjust the amount held in BTC as volatility changes.</p><details><summary>Why consider it?</summary><p>A sizing variant of MA125, not an independent signal. It may cut exposure before a recovery and needs testing against a simple smaller allocation.</p></details></article><article class="candidate-card"><span class="candidate-number">03</span><h3>Relative momentum</h3><p>Compare eligible liquid coins and hold those meeting a strength rule.</p><details><summary>Why consider it?</summary><p>Later research: requires multi-asset support and historical listings and liquidity data. Reversals, trading costs and correlated losses can erase an apparent advantage.</p></details></article></div><div class="selection-note"><h3>Your strategy stays your choice.</h3><p>Planned: compare eligible strategies, review the version and affected funds, then confirm your choice. A new listing will not replace your selection. Strategy switching is not implemented in this preview.</p></div></section>`;
const views = {
  home: () =>
    heading(
