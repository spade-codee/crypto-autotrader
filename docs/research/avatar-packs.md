# Profile avatars: soft 3D options for Nigerian users

- **Date:** 2026-09-22
- **For:** the founder and Codex. The founder chose soft 3D human profile characters, like Memoji,
  as the prototype's visual direction (`prototypes/customer/README.md`, `13ac344`). This compares
  real options; choosing and integrating remain the founder's and Codex's.
- **Checked:** licences and file details were read from each source, and are marked where they
...
exclusive rights. It is the only option that covers Nigerian hairstyles and headwear properly,
and it leaves no licence question open. Cost needs a quote.

**3. To buy instead: Toy Faces, by Amrit Pal Singh** — 120+ polished 3D avatars, 4,000 px PNGs, a
$70 bundle, built around diversity. **Its licence for app use conflicts:** the creator's page
lists "Apps" among allowed uses, but the creator has said on Product Hunt that embedding avatars
in a web or mobile app needs an extended licence. Get written confirmation that avatars users
select inside an app are covered before buying.
...
## Limits that apply whichever is chosen

From the spec (§3, *Profile portraits*) and the brand rules:

- Portraits show only the user — never the strategy, a trader, an "AI", other users, or a
  testimonial.
- Sample-only in the prototype: no uploads and no stored profile data.
- Keep them light: users are often on metered data.

## Sources

- Fluent Emoji: <https://github.com/microsoft/fluentui-emoji> and its
  [MIT licence](https://github.com/microsoft/fluentui-emoji/blob/main/LICENSE); folder names, skin
  tones, and image sizes read from the repository on 2026-09-22.
- Toy Faces: <https://amrit.art/toy-faces>, <https://amritpalsingh.gumroad.com/l/TBPeS>,
  <https://www.producthunt.com/products/toy-faces-library>.
- Craftwork: <https://craftwork.design/product/stylized-3d-avatars>,
  <https://userpics.craftwork.design/>.
- Black Illustrations: <https://www.blackillustrations.com/illustrations/the-ultimate-black-avatar-pack>.
